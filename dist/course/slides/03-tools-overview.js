    ...
    const tools = [
      ...
      },
      {
        ...
        body: '<div style="color:#444;font-size:0.82rem;line-height:1.7;margin-bottom:10px;">'
          ...
          + '<div style="width:32px;height:32px;background:#fff;border-radius:6px;display:flex;align-items:center;justify-content:center;flex-shrink:0;overflow:hidden;">'
          + '<img src="https://www.google.com/s2/favicons?domain=gmail.com&sz=64" style="width:24px;height:24px;display:block;" alt="Gmail" />'
          + '</div>'
          ...
          + '<div style="flex:1;min-width:160px;background:#2a2a2a;border-radius:8px;padding:10px 12px;display:flex;align-items:center;gap:10px;">'
          + '<div style="width:32px;height:32px;background:#fff;border-radius:6px;display:flex;align-items:center;justify-content:center;flex-shrink:0;overflow:hidden;">'
          + '<img src="https://www.google.com/s2/favicons?domain=drive.google.com&sz=64" style="width:24px;height:24px;display:block;" alt="Google Drive" />'
          + '</div>'
          ...
          + '<div style="flex:1;min-width:160px;background:#2a2a2a;border-radius:8px;padding:10px 12px;display:flex;align-items:center;gap:10px;">'
          + '<div style="width:32px;height:32px;background:#fff;border-radius:6px;display:flex;align-items:center;justify-content:center;flex-shrink:0;overflow:hidden;">'
          + '<img src="https://www.google.com/s2/favicons?domain=zapier.com&sz=64" style="width:24px;height:24px;display:block;" alt="Zapier" />'
          + '</div>'
