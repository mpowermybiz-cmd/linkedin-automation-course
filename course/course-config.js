...
{ id: '08-generating-your-first-graphic', component: '@slides/08-generating-your-first-graphic.js', title: 'Generate Your First Graphic', engagement: { required: false } },
    ...
    },
    {
      ...
      children: [
        { id: '09-google-apps-script-setup', component: '@slides/09-google-apps-script-setup.js', title: 'Content Calendar & Webhook Setup', engagement: { required: false } },
      ],
    },
    {
      type: 'section',
    ...
    },
    {
      ...
      children: [
        { id: '17-giving-claude-the-idea', component: '@slides/17-giving-claude-the-idea.js', title: 'Scheduled Task Automation Workflow', engagement: { required: false } },
