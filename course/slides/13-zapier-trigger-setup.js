export const slide = {
  render() {
    ...
    el.innerHTML = '<style>'
      ...
      + '<span style="background:#CC0000;color:#fff;font-size:0.68rem;font-weight:800;padding:3px 12px;border-radius:20px;letter-spacing:1px;">&#9654; WATCH FIRST</span>'
      + '<span style="color:#888;font-size:0.78rem;">Full Zapier walkthrough &mdash; watch this before following the steps below</span>'
      + '</div>'
      + '<div style="background:#0D0D0D;border-radius:12px;padding:clamp(4px,2vw,8px);box-shadow:0 6px 24px rgba(0,0,0,0.2);overflow:hidden;">'
      + '<video autoplay muted playsinline webkit-playsinline controls'
      + ' style="width:100%;height:auto;border-radius:6px;display:block;max-height:min(460px,65vw);background:#000;object-fit:contain;"'
      + ' preload="auto">'
      + '<source src="./course/assets/video/zapier-tutorial.mp4" type="video/mp4">'
      + 'Your browser does not support the video tag.'
      + '</video>'
      + '</div>'
      + '<div style="text-align:center;margin-top:8px;color:#aaa;font-size:0.74rem;">Real Zapier setup walkthrough &mdash; follow along as you build each step below</div>'
      + '</div>'
